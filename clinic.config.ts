...
const config: ClinicConfig = {
  ...
  hero: {
    ...
    imageAlt: 'Молодая пациентка на приёме у стоматолога',
  ...
  about: {
    ...
    imageAlt: 'Кабинет стоматолога с профессиональным оборудованием',
    years: '15+',
  ...
  team: {
    ...
    members: [
      ...
      },
      {
        ...
        photo: '/images/team/doctor-3.webp',
      },
      {
